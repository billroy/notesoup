...
function showExtendedDebug() {
	...
	if (debugWindow == null) {
		...
		debugWindow = new Window('debug_window', {className: 'dialog',width:250, height:100, right:4, minWidth:250, bottom:42, zIndex:10000, opacity:1, showEffect: Element.show, resizable: true, title: "Debug"})
